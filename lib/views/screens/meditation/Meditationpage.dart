...
import '../../../model/home_model/Quick&easy_model.dart';
import '../../../model/homemodel/home_section_model.dart';
import '../../utils/textwidget.dart';
import '../homepage/see_all_page.dart';
...
class _MeditationPageState extends State<MeditationPage> {
  @override
  void initState() {
    kHomeController.homeTabSectionServices(context);
    super.initState();
  }

  Future onRefresh() async {
    kHomeController.homeTabSection.value.relaxMeditation.clear();
    kHomeController.homeTabSectionServices(context);
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// =================== Meditation ===================
                  Center(
                    child: Styles.regular(S.of(context).meditation,
                        ff: 'regular', fs: 40.sp, c: Constant.whiteColor),
                  ),
                  homeTabSection(),
  ...
  Widget homeTabSection() {
    return StreamBuilder<QuickEasyModel>(
      stream: kHomeController.homeTabSection.stream,
            ...
            itemBuilder: (context, index) {
              ...
              return Column(
                ...
                children: [
                  ...
                  Container(
                    height: 220.h,
                    child: StreamBuilder<HomeSectionModel>(
                      stream: kHomeController.homeTabSectionIDServices(
