...
import 'BreathCircle/breathcircle_unwind.dart';
import 'Relax.dart';

class UnwindBreath extends StatefulWidget {
  const UnwindBreath({Key? key}) : super(key: key);

  @override
  _UnwindBreathState createState() => _UnwindBreathState();
}

class _UnwindBreathState extends State<UnwindBreath> {
        ...
        children: [
          ...
          Center(
            child: Container(
              height: 45.h,
              width: 45.w,
              child: SvgPicture.asset("assets/icons/breath4.svg"),
            ),
          ),
          ...
          Column(
            children: [
              Styles.regular(S.of(context).aVoluntaryBreathing,
                  ...
                  Column(
                    children: [
                      ...
                      Styles.regular(S.of(context).exhale,
                          c: Colors.grey, fs: 10.sp),
                      SizedBox(height: 7),
                      Styles.regular("7 ${S.of(context).second}",
                          c: Colors.grey, fs: 10.sp),
                    ],
                  ),
                  Column(
                    children: [
                      ...
                      Styles.regular(S.of(context).inhale,
                          c: Colors.grey, fs: 10.sp),
                      SizedBox(height: 7),
                      Styles.regular("8 ${S.of(context).second}",
                          c: Colors.grey, fs: 10.sp),
                    ],
                  ),
                ],
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: ChooseRoundMinute(
                            ...
                            breathScreen: S.of(context).unwind),
                      );
                    },
                  ),
                ),
...
class MSelectScreenUnwind extends StatefulWidget {
  MSelectScreenUnwind({Key? key}) : super(key: key);

  @override
  _MSelectScreenUnwindState createState() => _MSelectScreenUnwindState();
}

class _MSelectScreenUnwindState extends State<MSelectScreenUnwind> {
