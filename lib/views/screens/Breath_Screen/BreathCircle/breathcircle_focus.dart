...
class FocusBreathCircle extends StatefulWidget {
  final String? time;
  final Duration? duration;
  FocusBreathCircle({Key? key, this.time, this.duration}) : super(key: key);

  @override
  State<FocusBreathCircle> createState() => _FocusBreathCircleState();
}

class _FocusBreathCircleState extends State<FocusBreathCircle>
  ...
  void startBreathingCycle() {
    setState(() {
      displayText =
          inhaleExhale.value ? 'Inhale 4 Seconds' : 'Exhale 4 Seconds';
